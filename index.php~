...
.progress .prginfo {
	...
	<a class="mdl-color-text--white">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--grey-100">
          ...
          <a class="mdl-navigation__link" href="http://192.168.0.3:10000" target="_blank"><i class="mdl-color-text--black material-icons" role="presentation">settings</i>Webmin</a>
          <div class="mdl-layout-spacer"></div>
