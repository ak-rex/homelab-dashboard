...
.progress .prginfo {
	...
	<div class="mdl-card__supporting-text mdl-color-text--white">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-700">
          <a class="mdl-navigation__link" href="http://192.168.0.2" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">storage</i>Unraid</a>
          <a class="mdl-navigation__link" href="http://192.168.0.2:32400/web/index.html" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">play_circle_filled</i>Plex</a>
          <a class="mdl-navigation__link" href="http://192.168.0.2:8181" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">visibility</i>PlexPy</a>
          <a class="mdl-navigation__link" href="http://192.168.0.3:8112" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">swap_vertical_circle</i>Deluge</a>
          <a class="mdl-navigation__link" href="http://192.168.0.3:8989" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">fiber_dvr</i>Sonarr</a>
          <a class="mdl-navigation__link" href="http://192.168.0.3:5050" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">weekend</i>CouchPotato</a>
          <div class="mdl-layout-spacer"></div>
          <a class="mdl-navigation__link" href="https://github.com/ak-rex/Dashboard" target="_blank"><i class="mdl-color-text--blue-grey-200 material-icons" role="presentation">help_outline</i><span class="visuallyhidden">Help</span></a>
        </nav>
      </div>
      <main class="mdl-layout__content mdl-color--grey-100">
		...
		<?php echo "$du Used - $df Free - $dt Total"; ?></div>
	     ...
	     <img src="http://xxxx:xxxx@192.168.0.7/PSIA/Streaming/channels/201/picture" width="49%"></center>
            <div class="demo-separator mdl-cell--1-col"></div>
	    <center class="pattern">
	     <img src="http://xxxx:xxxx@192.168.0.7/PSIA/Streaming/channels/201/picture" width="49%">
      ...
      <a href="https://google.com.com" target="_blank" id="view-source" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-color-text--white">Google</a>
